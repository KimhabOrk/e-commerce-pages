        ...
        <div className="mx-auto max-w-6xl">
          <div className="text-center max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-center">
              ...
              <Link
                href={`/${locale}/company/responsibility`}
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <FeatureCard
              ...
              description="Responsibly sourced fabrics that minimize environmental impact without compromising quality."
              ctaText="Learn More"
              ctaHref={`/${locale}/company/responsibility`}
            />
            <FeatureCard
        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <FeatureCard
              ...
              ctaText="View Guides"
              ctaHref={`/${locale}/services/care-guides`}
            />
            <FeatureCard
      ...
      <section className="py-12 md:py-16 px-6 md:px-8 lg:px-10 bg-gradient-to-r from-primary to-primary/80 text-primary-foreground">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg mb-8 opacity-95 text-balance max-w-2xl mx-auto leading-relaxed">
            Join our community of women who value quality, sustainability, and style. Shop Kimhab Ork today and discover fashion that makes a difference.
          </p>
