            ...
            <div className="bg-muted p-8 rounded-lg border border-border/40">
              <ul className="space-y-4 text-foreground/70">
                <li className="flex gap-4">
                  <span className="font-semibold text-primary min-w-fit">Act Quickly:</span>
