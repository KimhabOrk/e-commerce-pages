      ...
      <section className="relative py-12 md:py-16 lg:py-32 px-4 md:px-6 lg:px-8 bg-gradient-to-b from-background to-muted">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="text-lg text-foreground/70 text-balance max-w-2xl mx-auto">
            Understanding how we use cookies and tracking technologies to enhance your experience
          </p>
        </div>
      </section>
      ...
      <section className="py-8 px-4 md:px-6 lg:px-8 bg-muted/40">
        <div className="mx-auto max-w-4xl">
          <div className="relative w-full h-auto rounded-lg overflow-hidden border border-border/40">
            <Image
              src="/images/img-20260212-044408.jpg"
              alt="Cookie Policy Reference Document"
              width={1200}
              height={1600}
              loading="eager"
