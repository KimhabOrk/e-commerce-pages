...
const sideImages = [
  {
    src: "https://i.ibb.co/5xtvdmPD/hero-side-1.png",
    alt: "Modern architecture with corten steel",
    position: "left",
    span: 1,
  },
  {
    src: "https://i.ibb.co/gMx4HtcG/hero-side-2.png",
    alt: "Aerial view of modern home",
    position: "left",
    span: 1,
  },
  {
    src: "https://i.ibb.co/394KWqt5/hero-side-3.png",
    alt: "Interior view with landscape",
    position: "right",
    span: 1,
  },
  {
    src: "https://i.ibb.co/wF5Cz6YJ/hero-side-4.png",
        ...
        <div className="flex h-full w-full items-center justify-center">
          ...
          >
            ...
            >
              ...
              <Image
                src="https://i.ibb.co/Hpn0tPcD/hero-mono.png"
