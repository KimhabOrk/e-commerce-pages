...
const accessories = [
  {
    ...
    price: "$89",
    image: "https://i.ibb.co/SwDGBCgp/accessory-charger.png",
  },
  {
    id: 2,
    ...
    price: "$45",
    image: "https://i.ibb.co/HL0DWf7m/accessory-sleeve.png",
  },
  {
    id: 3,
    ...
    price: "$129",
    image: "https://i.ibb.co/3yDCYSkH/accessory-bike-mount.png",
  },
  {
    id: 4,
    ...
    price: "$39",
    image: "https://i.ibb.co/TqDd33cy/accessory-strap.png",
  },
  {
    id: 5,
    ...
    price: "$29",
    image: "https://i.ibb.co/XZ3kww9d/accessory-carabiner.png",
  },
  {
    id: 6,
    ...
    price: "$149",
    image: "https://i.ibb.co/3bjsP2x/accessory-speaker-base.png",
  },
];
  ...
  return (
    <section id="accessories" className="relative max-w-screen bg-background">
      ...
      <div className="pb-12 md:pb-24">
        ...
        {/* Desktop: Grid */}
        <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8 md:px-12 lg:px-20">
          {accessories.map((accessory) => (
