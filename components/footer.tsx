  ...
  return (
    <footer className="w-full border-t border-border/60 bg-background pt-8">
      <div className="relative mx-auto max-w-6xl justify-center items-center flex flex-col px-6 md:px-8 lg:px-10 py-6 md:py-12">
        <div className="grid grid-cols-3 gap-5 md:gap-10 mb-4">
          {/* Company Links */}
          <div>
            <h4 className="font-semibold text-white mb-2 text-sm md:text-md">Company</h4>
          ...
          {/* Support Links */}
          <div>
            <h4 className="font-semibold text-white mb-2 text-sm md:text-md">Support</h4>
            <ul className="space-y-2 text-sm md:text-md">
              <li>
                <Link
          ...
          {/* Legal Links */}
          <div>
            <h4 className="font-semibold text-white mb-2 text-sm md:text-md">Legal</h4>
            <ul className="space-y-2 text-sm md:text-md">
              <li>
                <Link
                  href="/legal/notes"
