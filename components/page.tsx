              ...
              <div className="space-y-6">
                <div>
                  ...
                  <p className="text-foreground/70 leading-relaxed">
                    With over 15 years of experience in luxury fashion design, Sokhearn founded Kimhab Ork with a singular vision: to make high-quality, sustainably-produced womenswear accessible to everyone without compromising on elegance or ethics.
                  </p>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed">
                      Sokhearn believes that beautiful design transcends price points. Every piece in our collection reflects a commitment to timeless silhouettes, premium materials, and meticulous craftsmanship—all at prices that celebrate affordability.
                    </p>
                  </div>

                  <div>
                    <h3 className="font-semibold text-primary mb-2">Sustainability Mission</h3>
                    <p className="text-foreground/70 leading-relaxed">
                      Driven by environmental consciousness, Sokhearn leads our responsibility initiatives, ensuring every garment is produced ethically and sustainably. The vision extends beyond fashion to create positive impact on communities and our planet.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="py-12 md:py-16 px-4 md:px-6 lg:px-8">
          <div className="mx-auto max-w-6xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
              <div className="space-y-4">
                <h3 className="font-serif text-2xl font-bold text-foreground">Early Inspiration</h3>
                <p className="text-foreground/70 leading-relaxed">
                  Growing up in Cambodia, Sokhearn was captivated by the rich textile traditions and artisan craftsmanship that defines the region. This early exposure sparked a passion for creating fashion that honors heritage while embracing modern aesthetics.
                </p>
              </div>

              <div className="space-y-4">
                <h3 className="font-serif text-2xl font-bold text-foreground">Global Experience</h3>
                <p className="text-foreground/70 leading-relaxed">
                  After studying fashion design in Paris and working with renowned luxury houses across Europe and Asia, Sokhearn gained invaluable insights into craftsmanship, sustainability, and the disconnect between luxury and accessibility.
                </p>
              </div>

              <div className="space-y-4">
                <h3 className="font-serif text-2xl font-bold text-foreground">Founding Vision</h3>
                <p className="text-foreground/70 leading-relaxed">
                  In 2018, Sokhearn founded Kimhab Ork to challenge the luxury fashion industry. The brand was born from a question: why should quality, sustainability, and beautiful design be exclusive to the wealthy?
                </p>
              </div>

              <div className="space-y-4">
                <h3 className="font-serif text-2xl font-bold text-foreground">Present Impact</h3>
                <p className="text-foreground/70 leading-relaxed">
        ...
        <section className="py-12 md:py-16 px-4 md:px-6 lg:px-8 bg-muted/30">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="text-lg text-foreground/70 mb-8 leading-relaxed">
              Follow Sokhearn and Kimhab Ork on social media to stay updated on new collections, behind-the-scenes stories, and our journey toward redefining luxury fashion.
            </p>
